...
export const allProductsData: Product[] = [
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1671548185843-3f50c6c1060b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxob25leSUyMGxpcXVpZCUyMGdvbGRlbnxlbnwxfHx8fDE3NjEzMTA3NjB8MA&ixlib=rb-4.1.0&q=80&w=1080', '/natural-liquid-jaggery.jpg', '/hoveer_image2.jpeg'],
    category: 'liquid',
    rating: 4.7,
    reviewCount: 156,
    inStock: true,
  ...
  },
  {
    ...
    images: ['/jaggery-powder.jpg', '/jaggery-powder2.webp', '/hover_video3.jpeg'],
    category: 'powder',
    rating: 4.4,
    reviewCount: 87,
    inStock: true,
